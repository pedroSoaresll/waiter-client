<template>
  <v-layout row wrap class="mt-5">
    ...
    <v-flex xs12 class="mt-3" v-if="orderRequested.length">
      <v-data-table item-key="orders-closed" rows-per-page-text="Itens por página" :headers="headersRequested" :items="orderRequested"
    ...
    <v-flex xs12 class="mt-2">
      <v-btn v-if="orderRequested.length" block round color="orange" class="white--text">Feche a minha conta</v-btn>
      <template v-else>
