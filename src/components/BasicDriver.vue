...
export default {
  ...
  data: () => ({
    ...
    cpfRules: [v => !!v || "Nome é obrigatorio!"],
    cityRules: [v => !!v || "Cidade é obrigatorio!"],
    emailRules: [
      ...
      this.$apollo
        ...
        .then(result => {
          ...
          this.$store.commit("lead/setSteps", {
            GET_BASIC: { complete: true, invalid: !this.valid }
          });
        ...
        .catch(error => {
          ...
          this.verify = false;
          this.$store.commit("lead/setSteps", {
            GET_BASIC: { complete: false, invalid: !this.valid }
          });
