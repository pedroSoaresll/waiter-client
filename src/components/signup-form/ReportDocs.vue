    ...
    <v-layout column wrap xs12 class="wrapper">
      <v-form v-model="isFormValid">
        ...
        <v-flex column wrap xs12 class="mt-5">
          ...
          <img style="max-height: 200px;" :src="require('../../assets/cnh-example.jpeg')"
               alt="Imagem ilustrativa para demonstrar onde fica o número da CNH">
        ...
        <v-flex column wrap xs12 class="mt-5">
          ...
          <v-text-field
            ...
            label="Complemento (apto, sala, etc...)"></v-text-field>
          <v-text-field
            :rules="fieldRules" @blur="updateDriver" clearable v-model="input.address_city"
        ...
        <v-flex column wrap xs12 class="mt-5">
          ...
          <span class="subtitle">Envie uma foto de um comprovante de
            residência que cumpra os seguintes requisitos:</span>
          <ul class="requisites subtitle">
        ...
        <v-flex column wrap xs12 class="mt-5" v-if="garageOtherAddress">
          ...
          <v-text-field
            :rules="fieldRules" @blur="updateDriver" clearable label="CEP"></v-text-field>
          <v-text-field
            :rules="fieldRules" @blur="updateDriver" clearable label="Nome da Rua"></v-text-field>
          <v-text-field
            :rules="fieldRules" @blur="updateDriver" clearable label="Número da casa/apartamento"></v-text-field>
          <v-text-field
            :rules="fieldRules" @blur="updateDriver" clearable label="Complemento (Apt, Sala, etc...)"></v-text-field>
          <v-text-field
            :rules="fieldRules" @blur="updateDriver" clearable label="Cidade"></v-text-field>
          <v-text-field
            :rules="fieldRules" @blur="updateDriver" clearable label="Estado"></v-text-field>
          <upload-input
